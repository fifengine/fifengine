...
#ifndef LUA_GUICHAN_HDR
#define LUA_GUICHAN_HDR
...
namespace luaGui {
	...
	class TTFont : public gcn::SDLTrueTypeFont {
		public:
			TTFont(lua_State* L);
	...
	class AWidget {
		public:
			...
			gcn::SDLTrueTypeFont* lua2sdlttf_cast(lua_State *L);
		private:
...
#define LUAGUI_WIDGET_IMPL(name) \
	...
	inline bool f_hasFocus() { \
		return gcn::name::hasFocus(); \
	} \
