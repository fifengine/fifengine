...
setup(name='fife',
      ...
      packages = ['fife', 'fife.extensions', 'fife.extensions.pychan', 'fife.extensions.pychan.widgets', 'fife.extensions.pychan.dialogs', 'fife.extensions.pychan.widgets.ext', 'fife.extensions.serializers' ],
