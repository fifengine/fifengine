...
gui.actions.on_stresstest = function()
  ...
  -- Read maps
  local file = io.open("content/etc/maps_fo1.txt")
  local i = 0
  lchooser.toload = {}
...
function main_menu()
  ...
  sx = 330
  sy = 400
  level_list = create_level_listmodel("content/etc/maps_fo1.txt")
  ...
  inner = create_window("Choose a Fallout 1 Map",sx,sy, small_font)
