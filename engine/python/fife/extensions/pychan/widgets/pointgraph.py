...
class PointGraph(Widget):
	...
	def __init__(self,
		...
		super(PointGraph, self).__init__(parent=parent,
									 name=name,
									 size=size,
									 min_size=min_size,
									 max_size=max_size,
		...
		if point_color is not None: self.point_color = point_color


	def clone(self, prefix):
		pointGraphClone = PointGraph(None,
