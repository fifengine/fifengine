...
class Slider(Widget):
    ...
    def __init__(self,
        ...
        self.real_widget = fifechan.Slider(scale_start
                                           or self.DEFAULT_SCALE_START,
                                           scale_end or self.DEFAULT_SCALE_END)
    ...
    def clone(self, prefix):
        sliderClone = Slider(
            ...
            self.scale_start, self.scale_end, self.step_length,
            self.marker_length, self.orientation)
        return sliderClone
