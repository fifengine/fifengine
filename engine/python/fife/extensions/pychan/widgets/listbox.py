...
class ListBox(Widget):
    ...
    def __init__(self,
        ...
        if selected is not None and items is not None:
            if len(items) > 0 and selected < len(items) and selected > 0:
                ...
                raise RuntimeError(
                    "Invalid selected item index specified for listbox!")
    ...
    def clone(self, prefix):
        ...
        listboxClone = ListBox(
            ...
            itemsList, self.selected)

        return listboxClone

    def _getItems(self):
        return self._items  #self.real_widget.getListModel() works too
    ...
    def _getSelected(self):
        return self.real_widget.getSelected()

    def _setSelected(self, index):
        self.real_widget.setSelected(index)
