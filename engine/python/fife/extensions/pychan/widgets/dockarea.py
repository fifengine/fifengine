...
class DockArea(ResizableWindow):
    ...
    def clone(self, prefix):
        dockAreaClone = DockArea(
            ...
            self.shove, self.cursors, self.active, self.side,
    ...
    def _getActiveDockArea(self):
        return self.real_widget.isActiveDockArea()

    def _setActiveDockArea(self, active):
        self.real_widget.setActiveDockArea(active)
