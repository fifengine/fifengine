...
class FifePychanSettings(Setting):
    def __init__(self,
        ...
        super(FifePychanSettings,
              self).__init__(app_name, settings_file, default_settings_file,
                             copy_dist, serializer)
...
class PychanSettingEntry(SettingEntry):
    def __init__(self,
                 ...
                 initialdata=None,
                 requiresrestart=False):
        super(PychanSettingEntry, self).__init__(module, name, applyfunction,
                                                 initialdata, requiresrestart)
