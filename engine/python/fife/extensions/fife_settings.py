            ...
            for name in self._settingsFromFile[module]:
                ...
                if name in self._validSetting[module]:
                    ...
                    if name == "InitialVolume":
                        ...
                        if int(e_value[0]) in range(
                                0, 256) and int(e_value[1]) in range(
                                    0, 256) and int(e_value[2]) in range(
                                        0, 256):
                    ...
                    elif name in ("SDLRemoveFakeAlpha", "LogToPrompt",
                                  "LogToFile"):
                        if type(e_value) == int:
                            try:
                                ...
                                self._logger.log_warn(
                                    "Invalid int-value for %s. Defaulted to False!"
                                    % name)
                                e_value = False
                            self._logger.log_warn(
