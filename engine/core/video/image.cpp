...
namespace FIFE {
	...
	Image::Image(SDL_Surface* surface): m_location(ResourceLocation("")), m_surface(NULL) {
		reset(surface);
	}

	Image::Image(const uint8_t* data, unsigned int width, unsigned int height): m_location(ResourceLocation("")) {
