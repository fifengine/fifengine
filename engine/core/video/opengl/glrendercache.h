...
#ifndef FIFE_VIDEO_OPENGL_RENDERCACHE_H
#define FIFE_VIDEO_OPENGL_RENDERCACHE_H
...
namespace FIFE {
	...
	class GLRenderCache : public RenderCache {
	public:
		/** Constructor.
		 */
		GLRenderCache();
