...
#ifndef FIFE_VIDEO_RENDERABLE_PROVIDER_H
#define FIFE_VIDEO_RENDERABLE_PROVIDER_H
...
namespace FIFE {
	 ...
	 * sure that the constructor and destructor never throw exceptions.
	...
	class RenderableProvider {
		public:
			 ...
			 *
			 * @return 0 on failure, the RenderAble otherwise.
			 */
		...
		protected:
			// Location of this RenderableProvider.
