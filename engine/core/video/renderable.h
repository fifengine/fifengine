...
namespace FIFE {
	 ...
	 * Animations are different, these are containers of Images and thus don't need any backend 
	 * specific sub-class. Still it is good to have the as a subclass to
