...
namespace FIFE {
	...
	void SoundEffectManager::createPresets() {
		EFXEAXREVERBPROPERTIES clangFun1 = EFX_REVERB_PRESET_GENERIC;
		m_presets[SE_PRESET_GENERIC] = clangFun1;
		EFXEAXREVERBPROPERTIES clangFun2 = EFX_REVERB_PRESET_PADDEDCELL;
		m_presets[SE_PRESET_PADDEDCELL] = clangFun2;
		EFXEAXREVERBPROPERTIES clangFun3 = EFX_REVERB_PRESET_ROOM;
		m_presets[SE_PRESET_ROOM] = clangFun3;
