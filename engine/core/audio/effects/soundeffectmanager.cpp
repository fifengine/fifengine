...
namespace FIFE {
	...
	void SoundEffectManager::createPresets() {
		EFXEAXREVERBPROPERTIES clangFun = EFX_REVERB_PRESET_GENERIC;
		m_presets[SE_PRESET_GENERIC] = clangFun;
		clangFun = EFX_REVERB_PRESET_PADDEDCELL;
		m_presets[SE_PRESET_PADDEDCELL] = clangFun;
		clangFun = EFX_REVERB_PRESET_ROOM;
		m_presets[SE_PRESET_ROOM] = clangFun;
