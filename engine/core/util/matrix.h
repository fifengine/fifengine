...
namespace FIFE
{
    ...
    public:
        ...
        inline Matrix& loadRotate(T angle, T x, T y, T z)
        {
            ...
            m0 = x*x*(1-c)+c;
//			std::cout << "thetha :" << angle << std::endl;
...
//			return *this;
        ...
        inline Matrix<double>& Rmult4by4(const Matrix<double>& mat)
        {
            Matrix<double> temp(*this);
        ...
        inline Matrix<double>& mult4by4(const Matrix<double>& mat)
        {
            Matrix<double> temp(*this);
...
//			std::cout << "cha:" <<  temp.m5<< " m5= " << mat.m1*temp.m4 + mat.m5*temp.m5  + mat.m9*temp.m6+mat.m13*temp.m7<< " = "
//			 << mat.m1 << "*" <<temp.m4<<" + " << mat.m5<<"*"<<mat.m5<<"  + "<<mat.m9<<"*"<<temp.m6<<"+"<<mat.m13<<"*"<<temp.m7
//			<< std::endl
//			;
