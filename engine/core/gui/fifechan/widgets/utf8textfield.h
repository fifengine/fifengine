...
#ifndef FCN_UTF8TEXTFIELD_HPP
#define FCN_UTF8TEXTFIELD_HPP
...
namespace fcn {
	 ...
	 * display such text (so fcn::ImageFont can not be used).
	 * 
	...
	public:
		 ...
		 * Key pressed handler.
		 *
		 * Overides fcn::TextField to handle UTF-8 character codes.
		 *
