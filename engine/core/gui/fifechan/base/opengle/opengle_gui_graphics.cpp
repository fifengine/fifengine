...
namespace FIFE {
	...
	void OpenGLeGuiGraphics::drawImage(const fcn::Image* image, int32_t srcX, int32_t srcY, int32_t dstX, int32_t dstY, int32_t width, int32_t height) {
	...
	void OpenGLeGuiGraphics::drawRectangle(const fcn::Rectangle& rectangle) {
		const fcn::ClipRectangle& top = mClipStack.top();
	...
	void OpenGLeGuiGraphics::fillRectangle(const fcn::Rectangle& rectangle) {
		const fcn::ClipRectangle& top = mClipStack.top();
	...
	bool OpenGLeGuiGraphics::pushClipArea(fcn::Rectangle area) {
	...
	void OpenGLeGuiGraphics::setColor(const fcn::Color& color) {
		mColor = color;
	}
}
