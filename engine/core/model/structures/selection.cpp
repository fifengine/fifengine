...
namespace FIFE { namespace model {
	...
	void Selection::initImageFromLayer() {
		// TODO: rewrite this! ImageCache no longer exists!
/*		if(m_layer) {
			std::string imagefile = m_layer->get<std::string>("_OVERLAY_IMAGE");
			Point offset = m_layer->get<Point>("_OVERLAY_IMAGE_OFFSET");
	...
	void Selection::render(Screen* screen, const Point& offset) {
		// rewrite this! ImageCache no longer exists!
