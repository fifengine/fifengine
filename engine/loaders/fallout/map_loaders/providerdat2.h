...
#ifndef FIFE_MAP_LOADERS_FALLOUT_PROVIDERDAT2_H
#define FIFE_MAP_LOADERS_FALLOUT_PROVIDERDAT2_H
...
namespace FIFE { namespace map { namespace loaders { namespace fallout {
	 ...
	 */
	class ProviderDAT2 : public VFSSourceProvider {
		public:
			/** Constructor
			 */
			ProviderDAT2() : VFSSourceProvider("Fallout2-dat") {}
