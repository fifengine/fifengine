...
class World(EventListenerBase):
    ...
    def loadLevel(self, filename):
        ...
        self._scene = Scene(
            self, self._engine, self._map.getLayer("objects"), self._soundmanager
        )
    ...
    def renderBoundingBox(self, obj):
        ...
        obj_topleft = fife.Point3D(bbox.x, bbox.y, 0.0)
        obj_topright = fife.Point3D(bbox.x + bbox.w, bbox.y, 0.0)
        obj_bottomright = fife.Point3D(bbox.x + bbox.w, bbox.y + bbox.h, 0.0)
        obj_bottomleft = fife.Point3D(bbox.x, bbox.y + bbox.h, 0.0)
        ...
        self._genericrenderer.addLine(
            "quads", node_topright, node_bottomright, 255, 255, 255
        )
        self._genericrenderer.addLine(
            "quads", node_bottomright, node_bottomleft, 255, 255, 255
        )
        self._genericrenderer.addLine(
            "quads", node_bottomleft, node_topleft, 255, 255, 255
        )
