...
namespace FIFEDIT{
	...
	public:
		 ...
		 */
		bool setSelectedObject(FIFE::MapObjectInfo* object);
		 ...
		 *  position.
		 */
		FIFE::MapObjectInfo* getSelectedObjectFromList(int position = 0);
		/** \brief Returns the list of currently selected objects. */
		std::list<FIFE::MapObjectInfo*> getSelectedObjectList();
	...
	private:
		/** FIFE Data Items */
		FIFE::Map* m_map_data;
		std::list<FIFE::MapObjectInfo*> m_selected_object_list;
