...
class StylingExample(PyChanExample):
    ...
    def start(self):
        ...
        self.styledCredits.distributeInitialData({
            'demoList':
            map(lambda x: unicode(x, 'utf8'), dir(pychan)),
            'demoText':
            unicode(pychan.__doc__, 'utf8')
        })
...
class ColorExample(PyChanExample):
    ...
    def update_basecolor(self):
        ...
        self.widget.findChild(name="base_rvalue").text = unicode(
            str(r), "utf-8")
        self.widget.findChild(name="base_gvalue").text = unicode(
            str(g), "utf-8")
        self.widget.findChild(name="base_bvalue").text = unicode(
            str(b), "utf-8")
        self.widget.findChild(name="base_avalue").text = unicode(
            str(a), "utf-8")
    ...
    def update_background_color(self):
        ...
        # update slider labels
        self.widget.findChild(name="background_rvalue").text = unicode(
            str(r), "utf-8")
        self.widget.findChild(name="background_gvalue").text = unicode(
            str(g), "utf-8")
        self.widget.findChild(name="background_bvalue").text = unicode(
            str(b), "utf-8")
        self.widget.findChild(name="background_avalue").text = unicode(
            str(a), "utf-8")
    ...
    def update_selection_color(self):
        ...
        # update slider labels
        self.widget.findChild(name="selection_rvalue").text = unicode(
            str(r), "utf-8")
        self.widget.findChild(name="selection_gvalue").text = unicode(
            str(g), "utf-8")
        self.widget.findChild(name="selection_bvalue").text = unicode(
            str(b), "utf-8")
        self.widget.findChild(name="selection_avalue").text = unicode(
            str(a), "utf-8")
    ...
    def update_foreground_color(self):
        ...
        # update slider labels
        self.widget.findChild(name="foreground_rvalue").text = unicode(
            str(r), "utf-8")
        self.widget.findChild(name="foreground_gvalue").text = unicode(
            str(g), "utf-8")
        self.widget.findChild(name="foreground_bvalue").text = unicode(
            str(b), "utf-8")
        self.widget.findChild(name="foreground_avalue").text = unicode(
            str(a), "utf-8")
...
class PychanTest(test.Test):
    ...
    def create(self, engine, application):
        ...
        self.gui.min_size = self._engine.getRenderBackend().getScreenWidth(
        ...
        # it later.
        credits.capture(
            lambda: credits._setText(u"CREDITS"), event_name="mouseEntered")
        # Note that we can't simply write:
        # credits.capture(credits._setText(u"Credits"), event_name="mouseExited")
        # that's because that would call credits._setText NOW and we want to call
        # it later.
        credits.capture(
            lambda: credits._setText(u"Credits"), event_name="mouseExited")
    ...
    def selectExample(self):
        ...
        self.gui.findChild(name="xmlSource").text = unicode(
