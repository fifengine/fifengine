...
namespace FIFE
{
    ...
    class FIFE_API ScreenMode
    {
        public:
            ...
            ScreenMode(ScreenMode const & rhs);

            ScreenMode& operator=(ScreenMode const &) = default;

            /** Destructor.
             */
            ~ScreenMode() = default;

            static uint32_t const WINDOWED_OPENGL   = 0x00000002;
            static uint32_t const FULLSCREEN_OPENGL = 0x00000003;
            static uint32_t const WINDOWED_SDL      = 0;
            static uint32_t const FULLSCREEN_SDL    = 0x00000001;

            bool operator<(ScreenMode const & rhs) const;
    ...
    class FIFE_API DeviceCaps
    {
        public:
             ...
             */
            std::vector<ScreenMode> const & getSupportedScreenModes() const
            {
