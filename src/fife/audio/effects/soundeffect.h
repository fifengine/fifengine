...
namespace FIFE
{
    ...
    class FIFE_API Equalizer : public SoundEffect
    {
        public:
            ...
            /** Sets mid1 gain, cut or boost signal on the mid1 range.
             * @param value Range 0.126 to 7.943, default 1.0.
             */
            ...
            /** Sets mid2 gain, cut or boost signal on the mid2 range.
             * @param value Range 0.126 to 7.943, default 1.0.
             */
            ...
            /** Sets high gain, cut or boost signal on the high range.
             * @param value Range 0.126 to 7.943, default 1.0.
             */
    ...
    class FIFE_API EaxReverb : public SoundEffect
    {
        public:
             ...
             */
            void setReflectionsPan(AudioSpaceCoordinate const & coordinate);
             ...
             * @param coordinate A 3D vector with values between 0.0 and 1.0.
             */
            void setLateReverbPan(AudioSpaceCoordinate const & coordinate);
