...
namespace FIFE
{
    ...
    class FIFE_API CellSelectionRenderer : public RendererBase
    {
        public:
            ...
            /** Copy Constructor.
             */
            CellSelectionRenderer(CellSelectionRenderer const & old);
            ...
            /** Destructor.
             */
            ~CellSelectionRenderer() override;
             ...
             */
            void selectLocation(Location const * loc);

            /** Deselects given location on map.
             *
             * @param loc The location.
             */
            void deselectLocation(Location const * loc);
