...
namespace FIFE
{
    ...
    class FIFE_API Object
    {
        public:
             ...
             */
            Object(std::string identifier, std::string name_space, Object* inherited = nullptr);
             ...
             */
            Action* createAction(std::string const & identifier, bool is_default = false);

            /** Gets action with given id. If not found, returns NULL
             */
            Action* getAction(std::string const & identifier, bool deepsearch = true) const;
             ...
             */
            void setDefaultAction(std::string const & identifier);
             ...
             */
            void addMultiPartId(std::string const & partId);
             ...
             * @param partId A const reference to a string that holds the identifier.
             */
            void removeMultiPartId(std::string const & partId);
             ...
             */
            void addMultiPartCoordinate(int32_t rotation, ModelCoordinate const & coord);
             ...
             */
            void addWalkableArea(std::string const & id);

            /** Removes an area id from walkable areas.
             * @param id The area id.
             */
            void removeWalkableArea(std::string const & id);
