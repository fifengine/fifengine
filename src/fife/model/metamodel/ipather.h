...
namespace FIFE
{
    ...
    class /*FIFE_API*/ IPather
    {
        public:
             ...
             * @param cost_id A const reference to the string that holds the cost identifier. You can use it optional
             ...
             */
            virtual bool followRoute(Location const & current, Route* route, double speed, Location& nextLocation) = 0;
