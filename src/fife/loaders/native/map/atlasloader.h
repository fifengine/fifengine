...
namespace FIFE
{
    ...
    class /*FIFE_API*/ Atlas
    {
        public:
             ...
             */
            ImagePtr getImage(std::string const & id);
             ...
             */
            bool addImage(std::string const & imagename, AtlasData const & data);

            /** Sets the image for atlas to use it for rendering.
             *  @remarks Should only be used during loading stage
             */
            void setPackedImage(ImagePtr const & image);
    ...
    class /*FIFE_API*/ AtlasLoader : public IAtlasLoader
    {
        public:
            ...
            AtlasPtr load(std::string const & filename) override;

            std::vector<AtlasPtr> loadMultiple(std::string const & filename) override;
