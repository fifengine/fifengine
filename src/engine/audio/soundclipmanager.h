...
namespace FIFE
{
    ...
    public:
         ...
         *
         */
        virtual SoundClipPtr create(const std::string& name, IResourceLoader* loader = nullptr);
         ...
         *
         */
        virtual SoundClipPtr load(const std::string& name, IResourceLoader* loader = nullptr);
