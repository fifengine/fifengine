...
namespace FIFE
{
    ...
    class /*FIFE_API*/ SoundEmitter
    {
        public:
             ...
             */
            void setSoundClip(SoundClipPtr const & soundClip);
             ...
             */
            void setSoundClip(std::string const & name);

            /** Reset the emitter, free all internal buffers
             *
             * @param defaultall If set to true, emitter position, velocity, gain and type will be set to the default
             * values
             */
             ...
             */
            void setPosition(AudioSpaceCoordinate const & position);
             ...
             */
            void setDirection(AudioSpaceCoordinate const & direction);
             ...
             */
            void setVelocity(AudioSpaceCoordinate const & velocity);
             ...
             */
            uint8_t getEffectNumber(SoundEffect const * effect);
             ...
             */
            void removeListener(SoundEmitterListener const * listener);
