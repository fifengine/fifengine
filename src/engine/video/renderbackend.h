...
namespace FIFE
{
    ...
    public:
        ...
        virtual void addImageToArray(
            uint32_t id, const Rect& rec, float const * st, uint8_t alpha, uint8_t const * rgba) = 0;
        ...
        virtual void drawThickLine(
            const Point& p1, const Point& p2, uint8_t width, uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255) = 0;

        /** Draws lines between given points with given RGBA and width.
         */
        virtual void drawPolyLine(
            const std::vector<Point>& points, uint8_t width, uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255) = 0;
        ...
        virtual void drawTriangle(
            const Point& p1, const Point& p2, const Point& p3, uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255) = 0;
         ...
         */
        virtual void drawVertex(const Point& p, uint8_t size, uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255) = 0;
        ...
        virtual void drawFillCircle(
            const Point& p, uint32_t radius, uint8_t r, uint8_t g, uint8_t b, uint8_t a = 255) = 0;
