...
namespace FIFE
{
    ...
    class /*FIFE_API*/ Cursor
    {
        public:
             ...
             */
            void setDrag(ImagePtr const & image, int32_t drag_offset_x = 0, int32_t drag_offset_y = 0);
             ...
             * @note to reset the cursors drag call cursor.setDrag(Cursor::CURSOR_NONE, 0, 0)
             */
            void setDrag(AnimationPtr const & anim, int32_t drag_offset_x = 0, int32_t drag_offset_y = 0);
        ...
        protected:
             ...
             */
            bool setNativeImageCursor(ImagePtr const & image);
