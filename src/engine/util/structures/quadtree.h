...
namespace FIFE
{
    ...
    template <typename DataType, int32_t MinimumSize>
    inline int32_t QuadNode<DataType, MinimumSize>::subnode(int32_t x, int32_t y, int32_t w, int32_t h) const
    {
        /*
    ...
    template <typename DataType, int32_t MinimumSize>
    QuadNode<DataType, MinimumSize>* QuadNode<DataType, MinimumSize>::find_container(
    ...
    template <typename DataType, int32_t MinimumSize>
    QuadNode<DataType, MinimumSize>* QuadNode<DataType, MinimumSize>::create_parent(
        int32_t x, int32_t y, int32_t w, int32_t h)
    {
        /*
    ...
    template <typename DataType, int32_t MinimumSize>
    QuadNode<DataType, MinimumSize>* QuadTree<DataType, MinimumSize>::find_container(
        int32_t x, int32_t y, int32_t w, int32_t h)
    {
