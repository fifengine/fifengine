...
namespace FIFE
{
    ...
    class /*FIFE_API*/ Instance : public FifeClass, public InstanceDeleteListener
    {
        public:
             ...
             */
            Instance(Object* object, Location const & location, std::string const & identifier = "");
             ...
             */
            void setLocation(Location const & loc);
             ...
             */
            void setFacingLocation(Location const & loc);
             ...
             */
            void move(
                std::string const & actionName, Location const & target, double speed, std::string const & costId = "");
             ...
             */
            void say(std::string const & text, uint32_t duration = 0);
             ...
             *  @param speed speed used for movement. Units = distance 1 in layer coordinates per second
             */
            void follow(std::string const & actionName, Instance* leader, double speed);
             ...
             *  @param speed speed used for movement. Units = distance 1 in layer coordinates per second
             */
            void follow(std::string const & actionName, Route* route, double speed);
             ...
             */
            std::string const * getSayText() const;
             ...
             */
            void setCost(std::string const & id, double cost);
             ...
             */
            std::vector<Instance*> const & getMultiInstances();
             ...
             */
            void addStaticColorOverlay(uint32_t angle, OverlayColors const & colors);
             ...
             */
            void addColorOverlay(std::string const & actionName, uint32_t angle, OverlayColors const & colors);

            /** Returns closest matching color overlay for given angle and action.
             * @return pointer to OverlayColor class
             */
            OverlayColors* getColorOverlay(std::string const & actionName, uint32_t angle);

            /** Removes a color overlay with given angle (degrees) from given action.
             */
            void removeColorOverlay(std::string const & actionName, int32_t angle);
             ...
             */
            std::map<int32_t, AnimationPtr> getAnimationOverlay(std::string const & actionName, int32_t angle);

            /** Removes animation overlay with given angle (degrees) and order from action.
             */
            void removeAnimationOverlay(std::string const & actionName, uint32_t angle, int32_t order);

            /** Adds new color overlay with given angle (degrees) and order to given action animation overlay.
             */
            void addColorOverlay(
             ...
             * @return pointer to OverlayColor class
             */
            OverlayColors* getColorOverlay(std::string const & actionName, uint32_t angle, int32_t order);

            /** Removes a color overlay with given angle (degrees), order from given action animation overlay.
             */
            void removeColorOverlay(std::string const & actionName, int32_t angle, int32_t order);

            /** If the action have base animation and optional color overlay it gets converted to animation overlay.
             */
            void convertToOverlays(std::string const & actionName, bool color);

            /** Indicates if there exists a animation overlay for given action.
             */
            bool isAnimationOverlay(std::string const & actionName);
        ...
        private:
            ...
            void initializeAction(std::string const & actionName);
            ...
            ActionVisual* getActionVisual(std::string const & actionName, bool create);
    };
} // namespace FIFE
