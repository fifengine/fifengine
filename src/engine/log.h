...
// 	class Console;
	...
	class Log {
		...
		public:
			...
			/** Destructor. Outputs the final log string to the standard output. 
			 */
			~Log();

			/** << operator. Used to allow the log item to operate like std::cout.
			 *
...
*/
			 ...
			 *
			 * Checks for --debug in the commend line and adds
