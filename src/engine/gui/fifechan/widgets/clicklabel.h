...
namespace fcn
{
        ...
        public WidgetListener
    {
        public:
             ...
             */
            explicit ClickLabel(std::string const & caption);

            virtual ~ClickLabel();

            ClickLabel(ClickLabel const &)            = delete;
            ClickLabel& operator=(ClickLabel const &) = delete;
             ...
             * @see setCaption
             */
            virtual std::string const & getCaption() const;
             ...
             */
            virtual void setCaption(std::string const & caption);
