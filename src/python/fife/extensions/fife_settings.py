...
class Setting:
    ...
    _validSetting = {
        "FIFE": {
            ...
            "WindowPositionX": [
                ...
                1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1920,
            ],
            ...
            "ScreenResolution": [
                "640x480", "800x600", "1024x600", "1024x768",
            ...
            "LogModules": [
                "all", "controller", "script", "video", "audio",
                "loaders", "vfs", "pool", "view", "model",
                "metamodel", "event_channel", "xml",
            ],
    ...
    _glyphDft = " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.,!?-+/():;%&amp;`'*#=[]\\\""
