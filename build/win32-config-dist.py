...
def addExtras(context):
	...
	context.env.Append(LIBS = ['mingw32', 'zlib', 'SDL_image', 'guichan', 'guichan_sdl', 'vorbis', 'ogg', 'vorbisfile', 'SDLmain', 'SDL', 'OpenAL32', 'SDL_ttf', 'boost_filesystem', 'boost_regex', 'png', 'python25'])
