==========================
FIFE Win32 compile guide for building pre-2008.0 SVN versions
==========================
...
4. Build files for each supported IDE can be found in the sub-directories of <FIFE>\build\win32\build_environments (code_blocks, scons, visual_studio_8). To make sure all paths are correct, please run <FIFE>\trunk\build\win32\update_project_files.bat.
...
7. You can now start your custom FIFE build by launching fo_remake.py & island_demo.py that reside in the subdirectories of <FIFE>\clients.
