...
===============================
FIFE Win32 DevKit April 2012
===============================

Changes:
===============================
* Added pre-built versions of guichan which includes all of our patches
* Upgraded boost to 1.47.0
* Upgraded mingw to gcc 4.5.1 from http://tdm-gcc.tdragon.net/download
